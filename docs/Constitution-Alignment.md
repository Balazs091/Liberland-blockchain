...
| --- | --- | --- |
| Land ownership and property administration | The land cadastre records versioned parcels, titles held by stable person/company/office IDs, source-document lineage, encumbrances, disputes, dual-party signed transfers, and atomic parcel operations. It does not decide substantive rights, validate maps, calculate fees, provide insurance/compensation, or execute court judgments. | Clean narrower implementation. Those omitted rules require defined land law, adjudication, and operational data standards; reviewed apps/policies and dedicated registries can add them later without a generic override. |
