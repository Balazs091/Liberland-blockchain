...
/// @title SepoliaDemoParameters
/// @notice Canonical short-lived demo deployment parameters for Sepolia only.
library SepoliaDemoParameters {
    ...
    uint256 internal constant LENDING_PER_PERSON_DEBT_CAP = 0;
